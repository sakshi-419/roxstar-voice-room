    ...
    <div className="room-layout">
      ...
      <div className={`audio-status-banner ${audioStateBadge.className}`}>
        ...
        <div className="room-actions">
          ...
          <button
            ...
            id="dispatch-btn"
          >
            🤖 {allAgentsActive ? 'AI Agents Connected' : (dispatchStatus || 'Summon AI Agents')}
          </button>
          <button
            type="button"
      ...
      <div className="participants-section">
        ...
        <div className="info-box">
          <strong>Two AI Co-Hosts Connected:</strong> Say <strong>"Dost..."</strong> to speak with Dost or <strong>"Sathi..."</strong> to speak with Sathi. AI agents remain silent until you speak. Follow-ups (e.g. <em>"thoda simple batao"</em>) will automatically continue with the current speaker!
        </div>
    ...
    >
      ...
      <div className="participant-meta">
        ...
        <div className="participant-audio-indicator">
          {isMicEnabled ? (
            <span className="audio-active">Mic Active</span>
          ) : (
