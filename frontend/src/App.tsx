    ...
    <div className="room-layout">
      ...
      <div className="participants-section">
        ...
        <div className="info-box">
          🎙️ <strong>Two AI Co-Hosts Connected:</strong> Say <strong>"Dost..."</strong> to speak with Dost or <strong>"Sathi..."</strong> to speak with Sathi. AI agents remain silent until you speak. Follow-ups (e.g. <em>"thoda simple batao"</em>) will automatically continue with the current speaker!
        </div>
